        ...
        <div className='bg-white shadow-md rounded-md px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                <div className='mb-3 min-w-72'>
                    <p className='text-sm-medium text-gray-700 mb-2'>Email Address</p>
                ...
                <div className='mb-3 min-w-72'>
                    <p className='text-sm-medium text-gray-700 mb-2'>Password</p>
                    <input onChange={(e)=>setPassword(e.target.value)} value={password} className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="password" placeholder='Enter Your password' required />
                </div>
                <button className='mt-2 px-4 py-2 w-full rounded text-white bg-black' type='submit'>Login</button>
            </form>
        </div>
    </div>
  )
